...
public class ExamController {
    ...
    public ExamController(ExamService examService, ExamEvaluationService examEvaluationService, ExamMapper examMapper) {
    ...
    @PutMapping("/{subject}")
    public ResponseEntity<ResponseDTO<ExamResponseDTO>> update(@PathVariable String subject,
            @RequestBody ExamRequestDTO update) {
        ResponseDTO<ExamResponseDTO> response = new ResponseDTO<>();
