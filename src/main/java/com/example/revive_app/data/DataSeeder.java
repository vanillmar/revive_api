...
public class DataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (permissionRepository.count() == 0 && roleRepository.count() == 0) {
            ...
            admin.setPermissions(Set.of(createUsers, createUser, deleteUser, readUsers, readUser, readMe));
            ...
            empUser.setRoles(Set.of(roleRepository.findByName("MODERATOR").orElseThrow(() -> new RuntimeException("Admin role not found"))));
