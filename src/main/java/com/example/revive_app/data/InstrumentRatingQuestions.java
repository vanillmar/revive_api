...
public class InstrumentRatingQuestions {
  ...
  // public record Question(String id, String question, List<String> options, int answerIndex,
  // Object category) {}
  ...
  public static List<Question> getQuestions(Subject instrumentRating) {
    return List.of(
        ...
        new Question(
            ...
            List.of(
                "(1) ATC, (2) much lower",
                "(1) the pilot in command, (2) much higher",
                "o Question 22 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
        ...
        new Question(
            ...
            List.of(
                "requires a minimum altitude of 8500 ft.",
                "is a waypoint that requires turn-anticipation.",
                "o Question 27 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
            ...
            List.of(
                "o Non-compulsory waypoint", "Compulsory waypoint", "o Question 28 of 122", "ID:"),
            0,
            instrumentRating),
        new Question(
            null,
        ...
        new Question(
            ...
            List.of(
                "at or above FL85.",
                "with the altimeter set to standard.",
                "o Question 42 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
            ...
            List.of(
                "SUDOG, descending to FL150.",
                "DUNBA, descending to FL150.",
                "o Question 43 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
        ...
        new Question(
            ...
            List.of(
                "(1) 6000 ft, (2) 270°", "(1) 6400 ft, (2) 270°", "o Question 89 of 122", "ID:"),
            0,
            instrumentRating),
        new Question(
            null,
        ...
        new Question(
            ...
            List.of(
                "o (1) ground-based facilities, (2) lateral guidance only by VOR or Localizer",
                "(2) GNSS waypoints, (2) lateral guidance only",
                "o Question 103 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
            ...
            List.of(
                "any published LPV minima.",
                "a curved segment in the arrival path.",
                "o Question 104 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
        ...
        new Question(
            ...
            List.of(
                "(1) without, (2) 200 ft", "(1) with, (2) 200 ft", "o Question 106 of 122", "ID:"),
            0,
            instrumentRating),
        new Question(
            null,
            ...
            List.of(
                "an augmented GNSS approach based on localizer performance without vertical guidance.",
                "a limited-precision approach based on ground-based facilities with vertical guidance.",
                "o Question 107 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
            ...
            List.of(
                "(1) LNAV minima, (2) additional equipment to standard GNSS receiver",
                "(1) LNAV minima, (2) standard GNSS equipment",
                "o Question 108 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
            ...
            List.of(
                "as a precision approach without vertical guidance by on-board systems.",
                "as a non-precision approach without vertical guidance by on-board systems.",
                "o Question 109 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
            ...
            List.of(
                "(1) 3D approach, (2) MDH or DH",
                "(1) 2D approach, (2) LNAV or LP",
                "o Question 110 of 122",
                "ID:"),
            0,
            instrumentRating),
        new Question(
        ...
        new Question(
            ...
            0,
            instrumentRating)
        // Note: The JSON is truncated and mixed with other sections. Add remaining questions
        // similarly if full JSON is available.
        // For brevity, I've included all explicitly listed questions from the provided text. The
        // last few are from mixed sections and may need cleaning.
