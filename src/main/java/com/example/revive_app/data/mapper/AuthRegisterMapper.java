...
public interface AuthRegisterMapper {
  @Mapping(
      target = "id",
      ignore = true) // ID is not present in source; can be set to null or generated elsewhere
  ...
  // Assumes Role has a no-arg constructor and a setter for ID (adjust if Role's ID type differs;
